...
public class RegisterUserActivity extends AppCompatActivity {
    ...
    EditText edName,edPhone,edCountry,edState,edCity,edAddress,edId;
    EditText edEmail,edPassword,edConfirmPassword;
    TextView tvRegisterAsSeller;
    ...
    private void initialize(){
        ...
        tvRegisterAsSeller=findViewById(R.id.tvRegisterAsSeller);
        ...
        edId.setText(String.valueOf(random.nextInt(9999)));
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View _view) {
                if (edId.getText().toString().trim().equals("") && (edName.getText().toString().trim().equals("") && (edPhone.getText().toString().trim().equals("") && (edCountry.getText().toString().trim().equals("") && (edState.getText().toString().trim().equals("")) && (edCity.getText().toString().trim().equals("")) && (edAddress.getText().toString().trim().equals("")) && (edEmail.getText().toString().trim().equals("")) && (edPassword.getText().toString().trim().equals("")) && (edConfirmPassword.getText().toString().trim().equals(""))))))
                {
                    Toast.makeText(RegisterUserActivity.this, "Please enter valid credentials", Toast.LENGTH_SHORT).show();
                }
                else {
                    if(edPassword.getText().toString().trim().equals(edConfirmPassword.getText().toString().trim())) {
                        if (edPassword.length() >= 8) {
                            if (img == 0) {
                                ...
                                for (int _repeat156 = 0; _repeat156 < (int) (listmap.size()); _repeat156++) {
                                    if (listmap.get((int) n).get("id").toString().toLowerCase().equals(edId.getText().toString().toLowerCase())) {
                                        Toast.makeText(RegisterUserActivity.this, "Id Already in Use", Toast.LENGTH_SHORT).show();
                                ...
                                if (exist == 0) {
                                    Currauth.createUserWithEmailAndPassword(edEmail.getText().toString(), edPassword.getText().toString()).addOnCompleteListener(RegisterUserActivity.this, _Currauth_create_user_listener);
                                    hashmap = new HashMap<>();
                                    hashmap.put("userName", edName.getText().toString().trim());
                                    ...
                                    Toast.makeText(RegisterUserActivity.this, "Successfully Signed Up.", Toast.LENGTH_SHORT).show();
                                    progressDialog.dismiss();
                                    finish();
                                } else {
                            ...
                            Toast.makeText(RegisterUserActivity.this, "Password Length is Small", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
                        Toast.makeText(RegisterUserActivity.this, "Password must match", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        _profile_upload_success_listener = new OnCompleteListener<Uri>() {
            ...
            public void onComplete(Task<Uri> _param1) {
                ...
                Currauth.createUserWithEmailAndPassword(edEmail.getText().toString().trim(), edPassword.getText().toString().trim()).addOnCompleteListener(RegisterUserActivity.this, _Currauth_create_user_listener);
                hashmap = new HashMap<>();
                hashmap.put("userName", edName.getText().toString().trim());
                hashmap.put("email", edEmail.getText().toString().trim());
                hashmap.put("password", edPassword.getText().toString().trim());
...
//This activity is use as a signup page for user, here user can register themself by providing the
// appropriate inputs